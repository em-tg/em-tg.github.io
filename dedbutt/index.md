...
In a way, the SSR trend in the React world is a return to the old paradigm: users can once again see the content of the page without waiting for a bunch of Javascript to download.  Unfortunately, this has brought back dead buttons: none of the widgets sent by the server are interactive until the Javascript that powers them is ready.  In fact, the situation is much worse than in the search engine example I presented earlier, since the size of modern Javascript bundles is much larger than they were in the past and institutional knowledge about progressive enhancement techniques has been lost.
